# [tg_bot_eve](https://t.me/tg_eve_bot) ссылка кликабельна
...
3. После завершения поиска бот отправит пользователю сообщение с актуальными ценами на выбранные позиции в различных регионах.
